...
import { X, Keyboard, Gamepad2, Smartphone, Zap, Shield, Trophy, Target } from "lucide-react";

interface Props {
  onClose: () => void;
}

type Tab = "controls" | "mechanics" | "mobile";
  ...
  return (
    <div className="flex flex-col gap-3">
      <div className="flex items-center gap-2">
        <div className="h-px flex-1 bg-gradient-to-r from-transparent" style={{ background: `linear-gradient(90deg,transparent,${color}40)` }} />
        ...
        <div className="overflow-y-auto flex-1 px-5 pb-6 pt-2 flex flex-col gap-5">
              ...
              <Section title="Saha Düzeni" color="#a78bfa">
                <div className="rounded-2xl border border-white/7 bg-white/3 p-4 grid grid-cols-3 gap-3 text-center text-xs">
                  <div className="flex flex-col items-center gap-1.5">
                    <div className="w-10 h-10 rounded-full bg-[#e63535]/20 border-2 border-[#e63535]/50 flex items-center justify-center text-[#e63535] font-black">
                      SEN
                    </div>
                  ...
                  <div className="flex flex-col items-center gap-1.5">
                    <div className="w-10 h-10 rounded-full bg-[#2266ee]/20 border-2 border-[#2266ee]/50 flex items-center justify-center text-[#4488ff] font-black">
                      RAK
                    </div>
          ...
          {tab === "mechanics" && (
            <>
              ...
              <Section title="Ranked Mod" color="#f59e0b">
              ...
              <Section title="Dokunmatik Kontroller" color="#4af">
                <div className="rounded-2xl border border-[#4af]/15 bg-[#4af]/5 p-4 flex flex-col gap-4">
                  <div className="grid grid-cols-2 gap-4">
                    ...
                    <div className="flex flex-col items-center gap-2">
                      <div className="flex flex-col items-center gap-1.5">
                        <div className="w-12 h-12 rounded-full bg-[#4ade80]/20 border-2 border-[#4ade80]/40 flex items-center justify-center text-lg">
                          ⚽
                        </div>
                        <div className="w-10 h-10 rounded-full bg-[#facc15]/20 border-2 border-[#facc15]/40 flex items-center justify-center text-sm">
                          💨
                        </div>
                      </div>
